            ...
            <div className="container">
                ...
                <form onSubmit={newsHandler} className="form">
                    <div className="form-inputs">
                        <label className="add-form-title">Заголовок
                            <input 
                        ...
                        <label className="add-form-title">Ваша почта
                            <input 
                                className="add-form-input" 
                                type="email" 
                                name="email" 
                        ...
                        <label className="add-form-img">Выберите файл
                            <input 
                                className="add-form-input"  
                                type="file" 
                                name="photo"
                    ...
                    <div className="form-textarea">
                        <label className="add-form-title">Tекст
                            <textarea 
